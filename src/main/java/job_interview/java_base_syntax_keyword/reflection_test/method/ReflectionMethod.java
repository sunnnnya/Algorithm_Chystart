package job_interview.java_base_syntax_keyword.reflection_test.method;
...
public class ReflectionMethod {
    ...
    public static void main(String[] args) throws Exception{
        Class<?> studentClazz = Class.forName("job_interview.java_base_syntax_keyword.reflection_test.method.ReflectionMethod$Student");
